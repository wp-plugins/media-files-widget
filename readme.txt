...
== Screenshots ==
1. Add the 'List Mediafiles' widget to one of the widget areas and specify title, number of files, order parameter and direction. You can also exclude files from the view. 
